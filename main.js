const TowersModule = () => {
  ...
  return {
    moveTowers: moveTowers,
    towers
  }
}

const TowersOfHanoi = TowersModule()

// uncomment for winning combination
// TowersOfHanoi.moveTowers(1,2);
// TowersOfHanoi.moveTowers(1,3);
// TowersOfHanoi.moveTowers(2,3);
// TowersOfHanoi.moveTowers(1,2);
// TowersOfHanoi.moveTowers(3,1);
// TowersOfHanoi.moveTowers(3,2);
// TowersOfHanoi.moveTowers(1,2);
